// To parse this data:
//
//   import { Convert, SemanticLocationHistoryAPRIL2019 } from "./file";
//
//   const semanticLocationHistoryAPRIL2019 = Convert.toSemanticLocationHistoryAPRIL2019(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryAPRIL2019 {
...
export class Convert {
    public static toSemanticLocationHistoryAPRIL2019(json: string): SemanticLocationHistoryAPRIL2019 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryAPRIL2019"));
    }

    public static semanticLocationHistoryAPRIL2019ToJson(value: SemanticLocationHistoryAPRIL2019): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryAPRIL2019")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryAPRIL2019": o([
