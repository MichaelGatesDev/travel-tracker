// To parse this data:
//
//   import { Convert, SemanticLocationHistorySEPTEMBER2019 } from "./file";
//
//   const semanticLocationHistorySEPTEMBER2019 = Convert.toSemanticLocationHistorySEPTEMBER2019(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistorySEPTEMBER2019 {
...
export class Convert {
    public static toSemanticLocationHistorySEPTEMBER2019(json: string): SemanticLocationHistorySEPTEMBER2019 {
        return cast(JSON.parse(json), r("SemanticLocationHistorySEPTEMBER2019"));
    }

    public static semanticLocationHistorySEPTEMBER2019ToJson(value: SemanticLocationHistorySEPTEMBER2019): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistorySEPTEMBER2019")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistorySEPTEMBER2019": o([
