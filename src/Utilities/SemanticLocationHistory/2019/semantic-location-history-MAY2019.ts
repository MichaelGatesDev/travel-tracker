// To parse this data:
//
//   import { Convert, SemanticLocationHistoryMAY2019 } from "./file";
//
//   const semanticLocationHistoryMAY2019 = Convert.toSemanticLocationHistoryMAY2019(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryMAY2019 {
...
export class Convert {
    public static toSemanticLocationHistoryMAY2019(json: string): SemanticLocationHistoryMAY2019 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryMAY2019"));
    }

    public static semanticLocationHistoryMAY2019ToJson(value: SemanticLocationHistoryMAY2019): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryMAY2019")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryMAY2019": o([
