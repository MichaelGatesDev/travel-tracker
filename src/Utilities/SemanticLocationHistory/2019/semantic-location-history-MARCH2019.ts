// To parse this data:
//
//   import { Convert, SemanticLocationHistoryMARCH2019 } from "./file";
//
//   const semanticLocationHistoryMARCH2019 = Convert.toSemanticLocationHistoryMARCH2019(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryMARCH2019 {
...
export class Convert {
    public static toSemanticLocationHistoryMARCH2019(json: string): SemanticLocationHistoryMARCH2019 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryMARCH2019"));
    }

    public static semanticLocationHistoryMARCH2019ToJson(value: SemanticLocationHistoryMARCH2019): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryMARCH2019")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryMARCH2019": o([
