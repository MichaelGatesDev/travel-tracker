// To parse this data:
//
//   import { Convert, SemanticLocationHistoryOCTOBER2019 } from "./file";
//
//   const semanticLocationHistoryOCTOBER2019 = Convert.toSemanticLocationHistoryOCTOBER2019(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryOCTOBER2019 {
...
export class Convert {
    public static toSemanticLocationHistoryOCTOBER2019(json: string): SemanticLocationHistoryOCTOBER2019 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryOCTOBER2019"));
    }

    public static semanticLocationHistoryOCTOBER2019ToJson(value: SemanticLocationHistoryOCTOBER2019): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryOCTOBER2019")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryOCTOBER2019": o([
