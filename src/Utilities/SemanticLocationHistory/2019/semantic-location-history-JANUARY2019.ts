// To parse this data:
//
//   import { Convert, SemanticLocationHistoryJANUARY2019 } from "./file";
//
//   const semanticLocationHistoryJANUARY2019 = Convert.toSemanticLocationHistoryJANUARY2019(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryJANUARY2019 {
...
export class Convert {
    public static toSemanticLocationHistoryJANUARY2019(json: string): SemanticLocationHistoryJANUARY2019 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryJANUARY2019"));
    }

    public static semanticLocationHistoryJANUARY2019ToJson(value: SemanticLocationHistoryJANUARY2019): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryJANUARY2019")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryJANUARY2019": o([
