// To parse this data:
//
//   import { Convert, SemanticLocationHistoryJULY2019 } from "./file";
//
//   const semanticLocationHistoryJULY2019 = Convert.toSemanticLocationHistoryJULY2019(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryJULY2019 {
...
export class Convert {
    public static toSemanticLocationHistoryJULY2019(json: string): SemanticLocationHistoryJULY2019 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryJULY2019"));
    }

    public static semanticLocationHistoryJULY2019ToJson(value: SemanticLocationHistoryJULY2019): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryJULY2019")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryJULY2019": o([
