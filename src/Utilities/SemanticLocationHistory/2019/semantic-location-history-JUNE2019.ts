// To parse this data:
//
//   import { Convert, SemanticLocationHistoryJUNE2019 } from "./file";
//
//   const semanticLocationHistoryJUNE2019 = Convert.toSemanticLocationHistoryJUNE2019(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryJUNE2019 {
...
export class Convert {
    public static toSemanticLocationHistoryJUNE2019(json: string): SemanticLocationHistoryJUNE2019 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryJUNE2019"));
    }

    public static semanticLocationHistoryJUNE2019ToJson(value: SemanticLocationHistoryJUNE2019): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryJUNE2019")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryJUNE2019": o([
