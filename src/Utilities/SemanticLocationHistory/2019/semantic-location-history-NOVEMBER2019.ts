// To parse this data:
//
//   import { Convert, SemanticLocationHistoryNOVEMBER2019 } from "./file";
//
//   const semanticLocationHistoryNOVEMBER2019 = Convert.toSemanticLocationHistoryNOVEMBER2019(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryNOVEMBER2019 {
...
export class Convert {
    public static toSemanticLocationHistoryNOVEMBER2019(json: string): SemanticLocationHistoryNOVEMBER2019 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryNOVEMBER2019"));
    }

    public static semanticLocationHistoryNOVEMBER2019ToJson(value: SemanticLocationHistoryNOVEMBER2019): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryNOVEMBER2019")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryNOVEMBER2019": o([
