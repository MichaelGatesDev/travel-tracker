// To parse this data:
//
//   import { Convert, SemanticLocationHistoryAUGUST2019 } from "./file";
//
//   const semanticLocationHistoryAUGUST2019 = Convert.toSemanticLocationHistoryAUGUST2019(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryAUGUST2019 {
...
export class Convert {
    public static toSemanticLocationHistoryAUGUST2019(json: string): SemanticLocationHistoryAUGUST2019 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryAUGUST2019"));
    }

    public static semanticLocationHistoryAUGUST2019ToJson(value: SemanticLocationHistoryAUGUST2019): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryAUGUST2019")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryAUGUST2019": o([
