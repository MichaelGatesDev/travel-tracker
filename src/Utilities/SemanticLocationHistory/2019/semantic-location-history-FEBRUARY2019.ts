// To parse this data:
//
//   import { Convert, SemanticLocationHistoryFEBRUARY2019 } from "./file";
//
//   const semanticLocationHistoryFEBRUARY2019 = Convert.toSemanticLocationHistoryFEBRUARY2019(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryFEBRUARY2019 {
...
export class Convert {
    public static toSemanticLocationHistoryFEBRUARY2019(json: string): SemanticLocationHistoryFEBRUARY2019 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryFEBRUARY2019"));
    }

    public static semanticLocationHistoryFEBRUARY2019ToJson(value: SemanticLocationHistoryFEBRUARY2019): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryFEBRUARY2019")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryFEBRUARY2019": o([
