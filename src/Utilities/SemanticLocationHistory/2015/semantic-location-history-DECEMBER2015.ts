// To parse this data:
//
//   import { Convert, SemanticLocationHistoryDECEMBER2015 } from "./file";
//
//   const semanticLocationHistoryDECEMBER2015 = Convert.toSemanticLocationHistoryDECEMBER2015(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryDECEMBER2015 {
...
export class Convert {
    public static toSemanticLocationHistoryDECEMBER2015(json: string): SemanticLocationHistoryDECEMBER2015 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryDECEMBER2015"));
    }

    public static semanticLocationHistoryDECEMBER2015ToJson(value: SemanticLocationHistoryDECEMBER2015): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryDECEMBER2015")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryDECEMBER2015": o([
