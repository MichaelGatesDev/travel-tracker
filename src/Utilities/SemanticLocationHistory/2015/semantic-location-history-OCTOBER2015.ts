// To parse this data:
//
//   import { Convert, SemanticLocationHistoryOCTOBER2015 } from "./file";
//
//   const semanticLocationHistoryOCTOBER2015 = Convert.toSemanticLocationHistoryOCTOBER2015(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryOCTOBER2015 {
...
export class Convert {
    public static toSemanticLocationHistoryOCTOBER2015(json: string): SemanticLocationHistoryOCTOBER2015 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryOCTOBER2015"));
    }

    public static semanticLocationHistoryOCTOBER2015ToJson(value: SemanticLocationHistoryOCTOBER2015): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryOCTOBER2015")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryOCTOBER2015": o([
