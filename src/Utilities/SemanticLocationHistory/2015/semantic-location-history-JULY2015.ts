// To parse this data:
//
//   import { Convert, SemanticLocationHistoryJULY2015 } from "./file";
//
//   const semanticLocationHistoryJULY2015 = Convert.toSemanticLocationHistoryJULY2015(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryJULY2015 {
...
export class Convert {
    public static toSemanticLocationHistoryJULY2015(json: string): SemanticLocationHistoryJULY2015 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryJULY2015"));
    }

    public static semanticLocationHistoryJULY2015ToJson(value: SemanticLocationHistoryJULY2015): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryJULY2015")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryJULY2015": o([
    ...
    "ActivitySegment": o([
        { json: "startLocation", js: "startLocation", typ: u(undefined, r("Location")) },
        { json: "endLocation", js: "endLocation", typ: u(undefined, r("Location")) },
