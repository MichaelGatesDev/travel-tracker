// To parse this data:
//
//   import { Convert, SemanticLocationHistoryAUGUST2015 } from "./file";
//
//   const semanticLocationHistoryAUGUST2015 = Convert.toSemanticLocationHistoryAUGUST2015(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryAUGUST2015 {
...
export class Convert {
    public static toSemanticLocationHistoryAUGUST2015(json: string): SemanticLocationHistoryAUGUST2015 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryAUGUST2015"));
    }

    public static semanticLocationHistoryAUGUST2015ToJson(value: SemanticLocationHistoryAUGUST2015): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryAUGUST2015")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryAUGUST2015": o([
