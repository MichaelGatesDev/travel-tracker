// To parse this data:
//
//   import { Convert, SemanticLocationHistorySEPTEMBER2015 } from "./file";
//
//   const semanticLocationHistorySEPTEMBER2015 = Convert.toSemanticLocationHistorySEPTEMBER2015(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistorySEPTEMBER2015 {
...
export class Convert {
    public static toSemanticLocationHistorySEPTEMBER2015(json: string): SemanticLocationHistorySEPTEMBER2015 {
        return cast(JSON.parse(json), r("SemanticLocationHistorySEPTEMBER2015"));
    }

    public static semanticLocationHistorySEPTEMBER2015ToJson(value: SemanticLocationHistorySEPTEMBER2015): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistorySEPTEMBER2015")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistorySEPTEMBER2015": o([
        { json: "timelineObjects", js: "timelineObjects", typ: a(r("TimelineObject")) },
    ], false),
    "TimelineObject": o([
        { json: "activitySegment", js: "activitySegment", typ: r("ActivitySegment") },
    ], false),
    "ActivitySegment": o([
