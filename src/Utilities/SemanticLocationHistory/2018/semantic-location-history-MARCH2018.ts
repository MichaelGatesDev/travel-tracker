// To parse this data:
//
//   import { Convert, SemanticLocationHistoryMARCH2018 } from "./file";
//
//   const semanticLocationHistoryMARCH2018 = Convert.toSemanticLocationHistoryMARCH2018(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryMARCH2018 {
...
export class Convert {
    public static toSemanticLocationHistoryMARCH2018(json: string): SemanticLocationHistoryMARCH2018 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryMARCH2018"));
    }

    public static semanticLocationHistoryMARCH2018ToJson(value: SemanticLocationHistoryMARCH2018): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryMARCH2018")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryMARCH2018": o([
