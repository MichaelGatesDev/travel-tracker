// To parse this data:
//
//   import { Convert, SemanticLocationHistoryJUNE2018 } from "./file";
//
//   const semanticLocationHistoryJUNE2018 = Convert.toSemanticLocationHistoryJUNE2018(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryJUNE2018 {
...
export class Convert {
    public static toSemanticLocationHistoryJUNE2018(json: string): SemanticLocationHistoryJUNE2018 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryJUNE2018"));
    }

    public static semanticLocationHistoryJUNE2018ToJson(value: SemanticLocationHistoryJUNE2018): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryJUNE2018")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryJUNE2018": o([
