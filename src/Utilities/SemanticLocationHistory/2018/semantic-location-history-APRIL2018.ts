// To parse this data:
//
//   import { Convert, SemanticLocationHistoryAPRIL2018 } from "./file";
//
//   const semanticLocationHistoryAPRIL2018 = Convert.toSemanticLocationHistoryAPRIL2018(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryAPRIL2018 {
...
export class Convert {
    public static toSemanticLocationHistoryAPRIL2018(json: string): SemanticLocationHistoryAPRIL2018 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryAPRIL2018"));
    }

    public static semanticLocationHistoryAPRIL2018ToJson(value: SemanticLocationHistoryAPRIL2018): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryAPRIL2018")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryAPRIL2018": o([
