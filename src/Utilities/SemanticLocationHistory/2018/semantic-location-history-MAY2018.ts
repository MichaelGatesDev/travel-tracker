// To parse this data:
//
//   import { Convert, SemanticLocationHistoryMAY2018 } from "./file";
//
//   const semanticLocationHistoryMAY2018 = Convert.toSemanticLocationHistoryMAY2018(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryMAY2018 {
...
export class Convert {
    public static toSemanticLocationHistoryMAY2018(json: string): SemanticLocationHistoryMAY2018 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryMAY2018"));
    }

    public static semanticLocationHistoryMAY2018ToJson(value: SemanticLocationHistoryMAY2018): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryMAY2018")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryMAY2018": o([
