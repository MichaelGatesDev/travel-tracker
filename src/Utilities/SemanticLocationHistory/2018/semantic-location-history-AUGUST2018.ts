// To parse this data:
//
//   import { Convert, SemanticLocationHistoryAUGUST2018 } from "./file";
//
//   const semanticLocationHistoryAUGUST2018 = Convert.toSemanticLocationHistoryAUGUST2018(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryAUGUST2018 {
...
export class Convert {
    public static toSemanticLocationHistoryAUGUST2018(json: string): SemanticLocationHistoryAUGUST2018 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryAUGUST2018"));
    }

    public static semanticLocationHistoryAUGUST2018ToJson(value: SemanticLocationHistoryAUGUST2018): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryAUGUST2018")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryAUGUST2018": o([
