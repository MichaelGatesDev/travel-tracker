// To parse this data:
//
//   import { Convert, SemanticLocationHistoryNOVEMBER2018 } from "./file";
//
//   const semanticLocationHistoryNOVEMBER2018 = Convert.toSemanticLocationHistoryNOVEMBER2018(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryNOVEMBER2018 {
...
export class Convert {
    public static toSemanticLocationHistoryNOVEMBER2018(json: string): SemanticLocationHistoryNOVEMBER2018 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryNOVEMBER2018"));
    }

    public static semanticLocationHistoryNOVEMBER2018ToJson(value: SemanticLocationHistoryNOVEMBER2018): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryNOVEMBER2018")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryNOVEMBER2018": o([
    ...
    "TransitPath": o([
        { json: "transitStops", js: "transitStops", typ: a(r("TransitStop")) },
