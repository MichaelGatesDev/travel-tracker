// To parse this data:
//
//   import { Convert, SemanticLocationHistoryOCTOBER2018 } from "./file";
//
//   const semanticLocationHistoryOCTOBER2018 = Convert.toSemanticLocationHistoryOCTOBER2018(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryOCTOBER2018 {
...
export interface PlaceVisit {
    location:        Location;
    duration:        Duration;
    placeConfidence: PlaceVisitPlaceConfidence;
...
export interface ChildVisit {
    location:         Location;
    duration?:        Duration;
    placeConfidence?: ChildVisitPlaceConfidence;
    centerLatE7?:     number;
    centerLngE7?:     number;
}

export enum ChildVisitPlaceConfidence {
    HighConfidence = "HIGH_CONFIDENCE",
    LowConfidence = "LOW_CONFIDENCE",
    MediumConfidence = "MEDIUM_CONFIDENCE",
}

export enum PlaceVisitPlaceConfidence {
    HighConfidence = "HIGH_CONFIDENCE",
    MediumConfidence = "MEDIUM_CONFIDENCE",
...
export class Convert {
    public static toSemanticLocationHistoryOCTOBER2018(json: string): SemanticLocationHistoryOCTOBER2018 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryOCTOBER2018"));
    }

    public static semanticLocationHistoryOCTOBER2018ToJson(value: SemanticLocationHistoryOCTOBER2018): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryOCTOBER2018")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryOCTOBER2018": o([
    ...
    "PlaceVisit": o([
        ...
        { json: "duration", js: "duration", typ: r("Duration") },
        { json: "placeConfidence", js: "placeConfidence", typ: r("PlaceVisitPlaceConfidence") },
    ...
    "ChildVisit": o([
        ...
        { json: "placeConfidence", js: "placeConfidence", typ: u(undefined, r("ChildVisitPlaceConfidence")) },
        { json: "centerLatE7", js: "centerLatE7", typ: u(undefined, 0) },
        { json: "centerLngE7", js: "centerLngE7", typ: u(undefined, 0) },
    ], false),
    "Confidence": [
    ...
    "ChildVisitPlaceConfidence": [
        "HIGH_CONFIDENCE",
        "LOW_CONFIDENCE",
        "MEDIUM_CONFIDENCE",
    ],
    "PlaceVisitPlaceConfidence": [
        "HIGH_CONFIDENCE",
        "MEDIUM_CONFIDENCE",
        "USER_CONFIRMED",
    ],
