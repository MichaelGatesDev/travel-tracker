// To parse this data:
//
//   import { Convert, SemanticLocationHistorySEPTEMBER2018 } from "./file";
//
//   const semanticLocationHistorySEPTEMBER2018 = Convert.toSemanticLocationHistorySEPTEMBER2018(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistorySEPTEMBER2018 {
...
export class Convert {
    public static toSemanticLocationHistorySEPTEMBER2018(json: string): SemanticLocationHistorySEPTEMBER2018 {
        return cast(JSON.parse(json), r("SemanticLocationHistorySEPTEMBER2018"));
    }

    public static semanticLocationHistorySEPTEMBER2018ToJson(value: SemanticLocationHistorySEPTEMBER2018): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistorySEPTEMBER2018")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistorySEPTEMBER2018": o([
