// To parse this data:
//
//   import { Convert, SemanticLocationHistoryFEBRUARY2018 } from "./file";
//
//   const semanticLocationHistoryFEBRUARY2018 = Convert.toSemanticLocationHistoryFEBRUARY2018(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryFEBRUARY2018 {
...
export class Convert {
    public static toSemanticLocationHistoryFEBRUARY2018(json: string): SemanticLocationHistoryFEBRUARY2018 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryFEBRUARY2018"));
    }

    public static semanticLocationHistoryFEBRUARY2018ToJson(value: SemanticLocationHistoryFEBRUARY2018): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryFEBRUARY2018")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryFEBRUARY2018": o([
