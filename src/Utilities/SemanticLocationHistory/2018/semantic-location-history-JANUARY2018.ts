// To parse this data:
//
//   import { Convert, SemanticLocationHistoryJANUARY2018 } from "./file";
//
//   const semanticLocationHistoryJANUARY2018 = Convert.toSemanticLocationHistoryJANUARY2018(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryJANUARY2018 {
...
export class Convert {
    public static toSemanticLocationHistoryJANUARY2018(json: string): SemanticLocationHistoryJANUARY2018 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryJANUARY2018"));
    }

    public static semanticLocationHistoryJANUARY2018ToJson(value: SemanticLocationHistoryJANUARY2018): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryJANUARY2018")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryJANUARY2018": o([
