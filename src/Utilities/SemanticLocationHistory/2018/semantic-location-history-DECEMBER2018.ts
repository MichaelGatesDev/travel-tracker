// To parse this data:
//
//   import { Convert, SemanticLocationHistoryDECEMBER2018 } from "./file";
//
//   const semanticLocationHistoryDECEMBER2018 = Convert.toSemanticLocationHistoryDECEMBER2018(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryDECEMBER2018 {
...
export class Convert {
    public static toSemanticLocationHistoryDECEMBER2018(json: string): SemanticLocationHistoryDECEMBER2018 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryDECEMBER2018"));
    }

    public static semanticLocationHistoryDECEMBER2018ToJson(value: SemanticLocationHistoryDECEMBER2018): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryDECEMBER2018")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryDECEMBER2018": o([
