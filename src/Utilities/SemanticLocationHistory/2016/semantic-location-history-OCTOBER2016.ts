// To parse this data:
//
//   import { Convert, SemanticLocationHistoryOCTOBER2016 } from "./file";
//
//   const semanticLocationHistoryOCTOBER2016 = Convert.toSemanticLocationHistoryOCTOBER2016(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryOCTOBER2016 {
...
export class Convert {
    public static toSemanticLocationHistoryOCTOBER2016(json: string): SemanticLocationHistoryOCTOBER2016 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryOCTOBER2016"));
    }

    public static semanticLocationHistoryOCTOBER2016ToJson(value: SemanticLocationHistoryOCTOBER2016): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryOCTOBER2016")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryOCTOBER2016": o([
    ...
    "ActivitySegment": o([
        ...
        { json: "confidence", js: "confidence", typ: u(undefined, "") },
    ...
    "PlaceVisit": o([
        ...
        { json: "placeConfidence", js: "placeConfidence", typ: u(undefined, "") },
    ], false),
};
