// To parse this data:
//
//   import { Convert, SemanticLocationHistoryAUGUST2016 } from "./file";
//
//   const semanticLocationHistoryAUGUST2016 = Convert.toSemanticLocationHistoryAUGUST2016(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryAUGUST2016 {
...
export class Convert {
    public static toSemanticLocationHistoryAUGUST2016(json: string): SemanticLocationHistoryAUGUST2016 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryAUGUST2016"));
    }

    public static semanticLocationHistoryAUGUST2016ToJson(value: SemanticLocationHistoryAUGUST2016): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryAUGUST2016")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryAUGUST2016": o([
    ...
    "ActivitySegment": o([
        ...
        { json: "simplifiedRawPath", js: "simplifiedRawPath", typ: r("SimplifiedRawPath") },
    ], false),
    "Activity": o([
