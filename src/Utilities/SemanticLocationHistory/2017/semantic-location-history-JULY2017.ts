// To parse this data:
//
//   import { Convert, SemanticLocationHistoryJULY2017 } from "./file";
//
//   const semanticLocationHistoryJULY2017 = Convert.toSemanticLocationHistoryJULY2017(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryJULY2017 {
...
export class Convert {
    public static toSemanticLocationHistoryJULY2017(json: string): SemanticLocationHistoryJULY2017 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryJULY2017"));
    }

    public static semanticLocationHistoryJULY2017ToJson(value: SemanticLocationHistoryJULY2017): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryJULY2017")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryJULY2017": o([
