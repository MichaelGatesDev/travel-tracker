// To parse this data:
//
//   import { Convert, SemanticLocationHistorySEPTEMBER2017 } from "./file";
//
//   const semanticLocationHistorySEPTEMBER2017 = Convert.toSemanticLocationHistorySEPTEMBER2017(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistorySEPTEMBER2017 {
...
export class Convert {
    public static toSemanticLocationHistorySEPTEMBER2017(json: string): SemanticLocationHistorySEPTEMBER2017 {
        return cast(JSON.parse(json), r("SemanticLocationHistorySEPTEMBER2017"));
    }

    public static semanticLocationHistorySEPTEMBER2017ToJson(value: SemanticLocationHistorySEPTEMBER2017): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistorySEPTEMBER2017")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistorySEPTEMBER2017": o([
