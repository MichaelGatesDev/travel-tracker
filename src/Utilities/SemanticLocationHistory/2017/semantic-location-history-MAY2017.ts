// To parse this data:
//
//   import { Convert, SemanticLocationHistoryMAY2017 } from "./file";
//
//   const semanticLocationHistoryMAY2017 = Convert.toSemanticLocationHistoryMAY2017(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryMAY2017 {
...
export class Convert {
    public static toSemanticLocationHistoryMAY2017(json: string): SemanticLocationHistoryMAY2017 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryMAY2017"));
    }

    public static semanticLocationHistoryMAY2017ToJson(value: SemanticLocationHistoryMAY2017): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryMAY2017")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryMAY2017": o([
