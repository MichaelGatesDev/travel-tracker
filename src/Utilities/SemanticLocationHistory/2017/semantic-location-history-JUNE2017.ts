// To parse this data:
//
//   import { Convert, SemanticLocationHistoryJUNE2017 } from "./file";
//
//   const semanticLocationHistoryJUNE2017 = Convert.toSemanticLocationHistoryJUNE2017(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryJUNE2017 {
...
export class Convert {
    public static toSemanticLocationHistoryJUNE2017(json: string): SemanticLocationHistoryJUNE2017 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryJUNE2017"));
    }

    public static semanticLocationHistoryJUNE2017ToJson(value: SemanticLocationHistoryJUNE2017): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryJUNE2017")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryJUNE2017": o([
