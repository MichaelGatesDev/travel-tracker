// To parse this data:
//
//   import { Convert, SemanticLocationHistoryNOVEMBER2017 } from "./file";
//
//   const semanticLocationHistoryNOVEMBER2017 = Convert.toSemanticLocationHistoryNOVEMBER2017(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryNOVEMBER2017 {
...
export class Convert {
    public static toSemanticLocationHistoryNOVEMBER2017(json: string): SemanticLocationHistoryNOVEMBER2017 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryNOVEMBER2017"));
    }

    public static semanticLocationHistoryNOVEMBER2017ToJson(value: SemanticLocationHistoryNOVEMBER2017): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryNOVEMBER2017")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryNOVEMBER2017": o([
