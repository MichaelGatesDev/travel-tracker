// To parse this data:
//
//   import { Convert, SemanticLocationHistoryAPRIL2017 } from "./file";
//
//   const semanticLocationHistoryAPRIL2017 = Convert.toSemanticLocationHistoryAPRIL2017(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryAPRIL2017 {
...
export class Convert {
    public static toSemanticLocationHistoryAPRIL2017(json: string): SemanticLocationHistoryAPRIL2017 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryAPRIL2017"));
    }

    public static semanticLocationHistoryAPRIL2017ToJson(value: SemanticLocationHistoryAPRIL2017): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryAPRIL2017")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryAPRIL2017": o([
