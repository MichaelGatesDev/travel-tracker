// To parse this data:
//
//   import { Convert, SemanticLocationHistoryJANUARY2017 } from "./file";
//
//   const semanticLocationHistoryJANUARY2017 = Convert.toSemanticLocationHistoryJANUARY2017(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryJANUARY2017 {
...
export class Convert {
    public static toSemanticLocationHistoryJANUARY2017(json: string): SemanticLocationHistoryJANUARY2017 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryJANUARY2017"));
    }

    public static semanticLocationHistoryJANUARY2017ToJson(value: SemanticLocationHistoryJANUARY2017): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryJANUARY2017")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryJANUARY2017": o([
