// To parse this data:
//
//   import { Convert, SemanticLocationHistoryOCTOBER2017 } from "./file";
//
//   const semanticLocationHistoryOCTOBER2017 = Convert.toSemanticLocationHistoryOCTOBER2017(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryOCTOBER2017 {
...
export class Convert {
    public static toSemanticLocationHistoryOCTOBER2017(json: string): SemanticLocationHistoryOCTOBER2017 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryOCTOBER2017"));
    }

    public static semanticLocationHistoryOCTOBER2017ToJson(value: SemanticLocationHistoryOCTOBER2017): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryOCTOBER2017")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryOCTOBER2017": o([
