// To parse this data:
//
//   import { Convert, SemanticLocationHistoryFEBRUARY2017 } from "./file";
//
//   const semanticLocationHistoryFEBRUARY2017 = Convert.toSemanticLocationHistoryFEBRUARY2017(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryFEBRUARY2017 {
...
export class Convert {
    public static toSemanticLocationHistoryFEBRUARY2017(json: string): SemanticLocationHistoryFEBRUARY2017 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryFEBRUARY2017"));
    }

    public static semanticLocationHistoryFEBRUARY2017ToJson(value: SemanticLocationHistoryFEBRUARY2017): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryFEBRUARY2017")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryFEBRUARY2017": o([
