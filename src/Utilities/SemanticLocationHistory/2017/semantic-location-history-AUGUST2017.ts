// To parse this data:
//
//   import { Convert, SemanticLocationHistoryAUGUST2017 } from "./file";
//
//   const semanticLocationHistoryAUGUST2017 = Convert.toSemanticLocationHistoryAUGUST2017(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryAUGUST2017 {
...
export class Convert {
    public static toSemanticLocationHistoryAUGUST2017(json: string): SemanticLocationHistoryAUGUST2017 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryAUGUST2017"));
    }

    public static semanticLocationHistoryAUGUST2017ToJson(value: SemanticLocationHistoryAUGUST2017): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryAUGUST2017")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryAUGUST2017": o([
    ...
    "ActivitySegment": o([
        { json: "startLocation", js: "startLocation", typ: r("EndLocation") },
