// To parse this data:
//
//   import { Convert, SemanticLocationHistoryMARCH2017 } from "./file";
//
//   const semanticLocationHistoryMARCH2017 = Convert.toSemanticLocationHistoryMARCH2017(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryMARCH2017 {
...
export class Convert {
    public static toSemanticLocationHistoryMARCH2017(json: string): SemanticLocationHistoryMARCH2017 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryMARCH2017"));
    }

    public static semanticLocationHistoryMARCH2017ToJson(value: SemanticLocationHistoryMARCH2017): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryMARCH2017")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryMARCH2017": o([
