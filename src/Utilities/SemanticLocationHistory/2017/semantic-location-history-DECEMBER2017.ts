// To parse this data:
//
//   import { Convert, SemanticLocationHistoryDECEMBER2017 } from "./file";
//
//   const semanticLocationHistoryDECEMBER2017 = Convert.toSemanticLocationHistoryDECEMBER2017(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SemanticLocationHistoryDECEMBER2017 {
...
export class Convert {
    public static toSemanticLocationHistoryDECEMBER2017(json: string): SemanticLocationHistoryDECEMBER2017 {
        return cast(JSON.parse(json), r("SemanticLocationHistoryDECEMBER2017"));
    }

    public static semanticLocationHistoryDECEMBER2017ToJson(value: SemanticLocationHistoryDECEMBER2017): string {
        return JSON.stringify(uncast(value, r("SemanticLocationHistoryDECEMBER2017")), null, 2);
    }
}
...
const typeMap: any = {
    "SemanticLocationHistoryDECEMBER2017": o([
